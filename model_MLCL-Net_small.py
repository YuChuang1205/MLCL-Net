...
@time: 
@desc:  这个版本是MLCL-Net的轻量化版本。即每阶段只用了2个block   paper:"Infrared small target detection based on multiscale local contrast learning networks"
"""
import torch
...
class MLCLNet_small(nn.Module):
    def __init__(self):
        super(MLCLNet_small, self).__init__()
        self.stage = Stage()
